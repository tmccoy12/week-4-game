...
function resetGame() {
  ...
  $("#stormtrooper-character").children(".health").html(stormTrooper.health);
...
$(document).ready(function () {
  ...
  $("#stormtrooper-character").on("click", function () {
    console.log("Stormtrooper is selected");
    ...
    if (characterSelected == false) {
      ...
      // Set the user's character
      initializeCharacter(stormTrooper);
      characterSelected = true;

      // Display the chosen character
      $("#stormtrooper-character").removeClass("available-character").addClass("chosen-character");
      $("#chosen-character").append(this);
      ...
      // User is choosing the defender
      if ($("#stormtrooper-character").hasClass("enemy-character")) {
        $("#game-message").empty();

        // Set the user's enemy
        initializeDefender(stormTrooper);
        defenderSelected = true;

        // Add the character to the defender section 
        $("#stormtrooper-character").removeClass("enemy-character").addClass("defender-character");
        $("#defender-section").append(this);
      }
    }
  });
    ...
    if (characterSelected && defenderSelected && !gameOver) {
      ...
      if (defender.health > 0) {
        ...
        if (enemiesDefeated === 3) {
          gameOver = true;
          $("#game-message").html("<p>You have won!!!</p><p>Play again?</p>");
          $("#restart").show();
        }
      }
